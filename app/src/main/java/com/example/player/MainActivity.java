...
public class MainActivity extends AppCompatActivity implements MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener {
    ...
    // создание полей
    private final String DATA_STREAM = "https://sheba.spb.ru/go/mz/via/Mirazh-MuzykaNasSviazala.mp3"; // ссылка на аудио поток
        ...
        try {
            switch (view.getId()) {
                case R.id.btnStream:
                    ...
                    nameAudio = "Музыка нас связала"; // инициализация названия контента
                    break;
                case R.id.btnRAW:
                    ...
                    toast.show(); // демонстрация тоста на экране
                    mediaPlayer = MediaPlayer.create(this, R.raw.komarovo); // создание дорожки с имеющимся аудио-файлом
                    mediaPlayer.start(); // старт данной дорожки
                    nameAudio = "Комарово"; // инициализация названия контента
                    break;
            }
